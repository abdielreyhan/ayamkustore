<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo base_url('asset/admin/')?>dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('Admin/Daftar_Gerai')?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('Admin/Tambah_Produk')?>" class="nav-link">
              <i class="nav-icon fa fa-dashboard"></i>
              <p>Tambah Produk</p>
            </a>
          </li>
